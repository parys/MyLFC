...
angular.module('users.ctrl', [])
    .controller('UserController', [
        '$stateParams', '$state', 'UsersFactory', 'RoleGroupFactory', '$uibModal', '$rootScope', 'Upload', 'Authentication',
        function ($stateParams, $state, UsersFactory, RoleGroupFactory, $uibModal, $rootScope, Upload, Authentication) {
            var vm = this;
            vm.user = [];
            vm.roleGroups = [];
