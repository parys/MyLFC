...
namespace MyLfc.Data.ResourceAccess.Migrations
{
    ...
    [Migration("20220911203124_AddedPostponedPropertyToMatch")]
    partial class AddedPostponedPropertyToMatch
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyLfc.Domain.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MaterialComments", (string)null);
                });
            ...
            modelBuilder.Entity("MyLfc.Domain.ForumSubsection", b =>
                {
                    ...
                    b.ToTable("ForumSubsections", (string)null);
                });
            ...
            modelBuilder.Entity("MyLfc.Domain.ForumTheme", b =>
                {
                    ...
                    b.ToTable("ForumThemes", (string)null);
                });
            ...
            modelBuilder.Entity("MyLfc.Domain.HelpEntity", b =>
                {
                    ...
                    b.ToTable("HelpEntities", (string)null);
                });

            modelBuilder.Entity("MyLfc.Domain.Identity.FullUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyLfc.Domain.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyLfc.Domain.MatchPerson", b =>
                {
                    ...
                    b.ToTable("MatchPersons", (string)null);
                });
            ...
            modelBuilder.Entity("MyLfc.Domain.Material", b =>
                {
                    ...
                    b.HasIndex("AdditionTime")
                        .HasDatabaseName("IX_Mat_AdditionTime");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("AdditionTime"), false);
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("Pending"), false);

                    b.HasIndex("Deleted", "Pending")
                        .HasDatabaseName("IX_Mat_Del_Pen");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("Deleted", "Pending"), false);

                    b.HasIndex("Deleted", "Pending", "OnTop")
                        .HasDatabaseName("IX_Mat_Del_Pen_Top");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("Deleted", "Pending", "OnTop"), false);
            ...
            modelBuilder.Entity("MyLfc.Domain.Polls.PollAnswerUser", b =>
                {
                    ...
                    b.ToTable("PollAnswerUsers", (string)null);
                });
            ...
            modelBuilder.Entity("MyLfc.Domain.RoleRoleGroup", b =>
                {
                    ...
                    b.ToTable("RoleRoleGroups", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("MyLfc.Domain.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MyLfc.Domain.Identity.FullUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyLfc.Domain.ChatMessage", b =>
                {
                    b.HasOne("MyLfc.Domain.Identity.FullUser", "Author")
            ...
            modelBuilder.Entity("MyLfc.Domain.Comment", b =>
                {
                    ...
                    b.HasOne("MyLfc.Domain.Comment", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("MyLfc.Domain.CommentVote", b =>
                {
                    b.HasOne("MyLfc.Domain.Comment", "Comment")
                        .WithMany("CommentVotes")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyLfc.Domain.Identity.FullUser", "User")
                        .WithMany("CommentVotes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyLfc.Domain.ForumTheme", b =>
                {
                    ...
                    b.HasOne("MyLfc.Domain.Identity.FullUser", "LastAnswerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyLfc.Domain.PrivateMessage", b =>
                {
                    b.HasOne("MyLfc.Domain.Identity.FullUser", "Receiver")
                        .WithMany("ReceivedPrivateMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyLfc.Domain.Identity.FullUser", "Sender")
            ...
            modelBuilder.Entity("MyLfc.Domain.RoleRoleGroup", b =>
                {
                    ...
                    b.HasOne("MyLfc.Domain.Identity.Role", "Role")
