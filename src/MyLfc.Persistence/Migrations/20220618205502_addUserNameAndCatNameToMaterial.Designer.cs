...
namespace MyLfc.Data.ResourceAccess.Migrations
{
    ...
    [Migration("20220618205502_addUserNameAndCatNameToMaterial")]
    partial class addUserNameAndCatNameToMaterial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyLfc.Domain.FullUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MyLfc.Domain.FullUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyLfc.Domain.ChatMessage", b =>
                {
                    b.HasOne("MyLfc.Domain.FullUser", "Author")
            ...
            modelBuilder.Entity("MyLfc.Domain.CommentVote", b =>
                {
                    ...
                    b.HasOne("MyLfc.Domain.FullUser", "User")
                        .WithMany("CommentVotes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyLfc.Domain.ForumTheme", b =>
                {
                    ...
                    b.HasOne("MyLfc.Domain.FullUser", "LastAnswerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyLfc.Domain.PrivateMessage", b =>
                {
                    b.HasOne("MyLfc.Domain.FullUser", "Receiver")
                        .WithMany("ReceivedPrivateMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyLfc.Domain.FullUser", "Sender")
