...
namespace MyLfc.Application.Features.Persons.Queries;

public class ParseAcademyPlayerQuery
{
    ...
    public class Handler : IRequestHandler<Request, Response>
    {
        ...
        {
            var trNodes = await HtmlExtractorHelpers.GetHtmlNodeAsync(request.Url);
